...
<body class="page-header-fixed">
                    ...
                    <li class="dropdown" id="header_inbox_bar">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                ...
                                <span class="photo"><img src="../../static/media/image/avatar2.jpg" alt="" /></span>
                            ...
                            <li>
                                ...
                                <span class="photo"><img src="./../../static/media/image/avatar3.jpg" alt="" /></span>
                            ...
                            <li>
                                ...
                                <span class="photo"><img src="./../../static/media/image/avatar1.jpg" alt="" /></span>
                ...
                <li class="">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            ...
                            <a href="javascript:void(0)" onclick="loadjsp('/user/toUserInfo')">用户信息管理</a>

                        </li>

                        <li >

                            <a href="javascript:void(0)" onclick="loadjsp('/user/toAdvancesUserInfo')">高级用户信息管理</a>
    ...
    <script>
        ...
        function loadjsp(str) {
        	$('#dashboard').load("${pageContext.request.contextPath}"+str);
		}
