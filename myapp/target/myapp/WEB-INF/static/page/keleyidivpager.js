...
var kkpager = {
    ...
    generPageHtml: function () {
        ...
        var gopage_info = '';
        if (this.isGoPage) {
            gopage_info = '&nbsp;转到第&nbsp;&nbsp;<span id="go_page_wrap" style="display:inline-block;width:44px;height:18px;margin:0px 1px;padding:0px;position:relative;left:0px;top:5px;">' +
					...
					'<input type="text" id="btn_go_input" onfocus="kkpager.focus_gopage()" onkeypress="if(event.keyCode<48 || event.keyCode>57)return false;" onblur="kkpager.blur_gopage()" style="width:44px;height:16px;text-align:center;border:0px;left:0px;top:0px;outline:none;" value="' + this.next + '" />'+
					'</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;页';
        }
        ...
        str = "&nbsp;" + str_prv + str + str_next +'<span style="float:right;"  class="normalsize">'+ total_info + gopage_info+'</span>';
